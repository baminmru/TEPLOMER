...
#region "total"
                        ...
                        if (TvMain.Status.Contains("assv"))
                        {
...
#region "hour"
                        ...
                        {
                            TvMain.SaveLog(id_bdc, archType_hour, "??", 1, "Чтение часового архива не разрешено в неоплаченной версии");
                        }
#region "day"
        ...
        private void AnalizeDevice(DataRow dr)
        {
            ...
            if (aCFG.Rows.Count > 0)
            {
                ...
                if (int.Parse(aCFG.Rows[0]["ANALIZENODE"].ToString()) != 0)
                {
                    ...
                    {
                        VIPAnalizer.NodeAnalizer na = new VIPAnalizer.NodeAnalizer();
                        na.AnalizeNode(TvMain, id_bdc, 21,true);
