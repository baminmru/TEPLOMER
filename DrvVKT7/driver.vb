...
Public Structure Archive
    ...
    Public M5 As Single
    Public M6 As Single
    Public Mg1 As Single
    Public Mg2 As Single
...
archErr:
    ...
    Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.Mg1, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.Mg2, "##############0.000000").Replace(",", ".") + ","
        ...
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.QG1, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.QG2, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.Tw1, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + NanFormat(Arch.Tw2, "##############0.000000").Replace(",", ".") + ","

        If Arch.HCtv1 = 0 Then Arch.HCtv1 = 32
        If Arch.HCtv2 = 0 Then Arch.HCtv2 = 32


        WriteArchToDB = WriteArchToDB + "'" + S180(Chr(Arch.HCtv1) & Chr(Arch.HCtv2)) + "','" + S180(Arch.MsgHC) + "',"
        WriteArchToDB = WriteArchToDB + "'" + S180(Arch.HCtv1) + "','" + S180(Arch.HCtv2) + "',"
        ...
        WriteArchToDB = WriteArchToDB + ",'" + S40(Arch.HCtv1.ToString()) + "'"
...
archerr:
    ...
    Public Overrides Function WriteTArchToDB() As String
        ...
        WriteTArchToDB = WriteTArchToDB + NanFormat(tArch.QG1, "##############0.000000").Replace(",", ".") + ","
        WriteTArchToDB = WriteTArchToDB + NanFormat(tArch.QG2, "##############0.000000").Replace(",", ".") + ","
                            ...
                            Try
                                Select Case ElemType
                                    ...
                                    Case VKT7ElemType.Mg_2TypeP
                                        ...
                                        Arch.mg2 = GetValue(sout, IsError)
                                        If IsHC Then
                                    ...
                                    Case VKT7ElemType.Mg_1TypeP
                                        ...
                                        Arch.mg1 = GetValue(sout, IsError)
                                        If IsHC Then
