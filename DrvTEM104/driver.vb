...
getInfo:
    ...
    Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = WriteArchToDB + Format(Arch.QG1, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Format(Arch.QG2, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Format(Arch.Tw1, "##############0.000000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Format(Arch.Tw2, "##############0.000000").Replace(",", ".") + ","
    ...
    '        WriteMArchToDB = WriteMArchToDB + Format(mArch.G4, "##############0.000000").Replace(",", ".") + ","
    '        WriteMArchToDB = WriteMArchToDB + Format(mArch.G5, "##############0.000000").Replace(",", ".") + ","
    '        WriteMArchToDB = WriteMArchToDB + Format(mArch.G6, "##############0.000000").Replace(",", ".") + ","
    ...
    Public Overrides Function WriteTArchToDB() As String
        ...
        WriteTArchToDB = WriteTArchToDB + Format(tArch.TW1, "##############0.000000").Replace(",", ".") + ","
        WriteTArchToDB = WriteTArchToDB + Format(tArch.TW2, "##############0.000000").Replace(",", ".") + ","
