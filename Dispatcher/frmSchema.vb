...
Public Class frmSchema
    ...
    Private Sub FillSchemas()
        ...
        For i = LBound(fi, 1) To UBound(fi, 1)
            ...
            Utils.LoadFileToField(fi(i).FullName, "devschema", "schema_image", "ds_id", fi(i).Name.Replace(".bmp", ""))
        Next
    ...
    Public Sub LoadData(ByVal newID As Integer)
        ...
        Else
            ...
            Utils.SaveFileFromField(fname, "devschema", "schema_image", "ds_id", ds_id)
            Try
                picSchema.Load(fname)
            Catch ex As Exception
    ...
    Private Sub cmdCreateSchema_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCreateSchema.Click
        Dim s As String
