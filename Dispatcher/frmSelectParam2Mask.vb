Public Class frmSelectParam2Mask
    ...
    Private Sub FillParam()
        ...
        chkParams.Items.Add("MG1", False)
        chkParams.Items.Add("MG2", False)
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
        ...
        For j = 0 To chkParams.CheckedItems.Count - 1
            Try
                Dim s As String
                Dim nn As String
                nn = chkParams.CheckedItems.Item(j)
                If nn.Contains("DANS") Then
                    nn = nn.Replace("DANS", "Q") & " Гк"
                End If


                s = "insert into masksline(id_maskl,id_mask,cfld,cheader,colwidth,colformat,colhidden) values( masksline_seq.nextval," + mask_id.ToString() + ",'" + chkParams.CheckedItems.Item(j) + "','" + nn + "'             ,80,'N',0)"
                TvMain.QueryExec(s)
