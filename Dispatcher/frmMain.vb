...
Public Class frmMain
    ...
    Public Sub ListBoxInit()
        ...
        If Not dt Is Nothing Then
            ...
            For i = 0 To dt.Rows.Count - 1
                LoadLevelData(dt.Rows.Item(i)("ID_GRP").ToString, TvMain.GetTable("v_dev2" & GrpPostFix, " where ID_GRP=" + dt.Rows.Item(i)("ID_GRP").ToString + " order by NodeName"), tree)
            Next
        End If
    ...
    Private Sub frmMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ListBoxInit()
        If TvMain.Status = "trial" Then
            Me.Text = "ТЕПЛОМЕР-IP. Диспетчер." & " Источник данных: " + TvMain.DataSourceName & ". Версия не оплачена"
        Else
            Me.Text = "ТЕПЛОМЕР-IP. Диспетчер." & " Источник данных: " + TvMain.DataSourceName
        End If
    ...
    Private Sub tree_AfterSelect(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinTree.SelectEventArgs) Handles tree.AfterSelect
        ...
        Else
            ...
            Else
                GrpPostFix = ""
            End If
            LoadLV(TvMain.GetTable("v_dev2" & GrpPostFix, " where ID_GRP=" + tree.SelectedNodes.Item(0).Tag + " order by NodeName"), ListView1)
        End If
    ...
    Private Sub mnuSetupModems_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuSetupModems.Click
    ...
    Private Sub mnuVerifyD24H_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuVerifyD24H.Click
        Dim dt As DataTable
        Dim an As LostAnalizer
        an = New LostAnalizer()
        an.tvmain = TvMain
