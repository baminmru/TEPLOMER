                ...
                If msg.cmd = cmdM4.cmd_ARCHIV Then 'msg.ID = mID And
                    ...
                    If block.teg = TegM4.teg_SEQUENCE And dok Then
                        ...
                        If Seq.Count >= 26 Then
                            ...
                            block = Seq(17)
                            If block.teg = TegM4.teg_IEEFloat Then Arch.Tw1 = BToSingle(block.data, 0)
                ...
                If msg.cmd = cmdM4.cmd_ARCHIV Then 'msg.ID = mID And
                    ...
                    If block.teg = TegM4.teg_SEQUENCE And dok Then
                        ...
                        If Seq.Count >= 26 Then
                            ...
                            block = Seq(17)
                            If block.teg = TegM4.teg_IEEFloat Then Arch.Tw2 = BToSingle(block.data, 0)
...
arch_final:
    ...
    Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = "INSERT INTO " & DBTableName & "(id_bd,DCALL,DCOUNTER,DATECOUNTER,id_ptype,t1,t2,t3,t4,t5,t6,tce1,tce2,tair1,tair2,p1,p2,p3,p4,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,sp_TB1,sp_TB2,q1,q2,q3,q4,TSUM1,TSUM2,oktime,oktime2,errtime,errtime2, hc_code,hc,hc_1,hc_2) values ("
        ...
        WriteArchToDB = WriteArchToDB + Arch.Q3.ToString.Replace(",", ".") + ","
        ...
        WriteArchToDB = WriteArchToDB + Arch.oktime2.ToString.Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Arch.errtime1.ToString.Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Arch.errtime2.ToString.Replace(",", ".") + ","
        ...
        If i > 0 Then
            If CheckCRC16(inbuf, 1, i + 7 - 3) Then
                If msg.cmd = cmdM4.cmd_PARAM Then 'msg.ID = mID And
                    ...
                    block = msg.Tegs(11)
                    If block.teg = TegM4.teg_FLAGS Then mArch.HCtv1 = block.data(1) * 256 + block.data(0)
                    mArch.MsgHCtv2 = DeCodeHC(mArch.HCtv2)
                    ok = True
                    GoTo march_final
                End If
        ...
        If i > 0 Then
            If CheckCRC16(inbuf, 1, i + 7 - 3) Then
                ...
                If msg.cmd = cmdM4.cmd_PARAM Then
                    ...
                    block = msg.Tegs(8)
                    If block.teg = TegM4.teg_IEEFloat Then tArch.TSUM2 = BToSingle(block.data, 0)
                    block = msg.Tegs(9)
                    If block.teg = TegM4.teg_IEEFloat Then tArch.TE2 = BToSingle(block.data, 0)
                    block = msg.Tegs(10)
                    If block.teg = TegM4.teg_IEEFloat Then tArch.TW2 = BToSingle(block.data, 0)
...
tarch_final:
    ...
    Public Overrides Function WriteTArchToDB() As String
        WriteTArchToDB = "INSERT INTO " & DBTableName & "(id_bd,DCALL,DCOUNTER,DATECOUNTER,id_ptype,Q1,Q2,Q4,Q5,M1,M2,M3,M4,M5,M6,v1,v2,v3,v4,v5,v6,oktime,errtime,TSUM1,oktime2,errtime2,TSUM2) values ("  ' 
        ...
        WriteTArchToDB = WriteTArchToDB + tArch.TE2.ToString.Replace(",", ".") + ","
