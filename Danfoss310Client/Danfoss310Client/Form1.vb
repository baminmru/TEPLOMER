...
Public Class Form1
    ...
    Private Sub НастройкаToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim f As frmSetup
        f = New frmSetup
        f.ShowDialog()
        f = Nothing
    ...
    Private Sub ПодключитьToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ВыходToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        master = Nothing
        Me.Close()
        End
    End Sub
